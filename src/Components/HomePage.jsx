...
const HomePage = () => {
  ...
  return (
    <div className="w-[100%] h-[100vh] bg-black overflow-x-hidden">
      <div className="text-white text-center p-3 bg-red-600 shadow-yellow-500 shadow-md">
      ...
      <div className="w-[100%]  pt-[6%] pb-6 flex mx-[10%]">
        ...
        <button 
          className="md:w-[140px] w-[100px] bg-white tracking-wide text-gray-800 font-thin rounded border-b-2 border-red-500 hover:border-red-600 hover:bg-red-500 hover:text-white shadow-md md:py-3 py-2 md:px-6 px-3 inline-flex items-center ml-10"
      ...
      <div className="w-full pt-7">
        <div>
          <h2 className="text-center text-white pb-5 pt-5 tracking-widest md:text-[30px] text-[20px]">Searched Results</h2>
          <div className='w-[70%] mx-auto bg-red-500 h-[1px]'></div>
          {loading ? (
